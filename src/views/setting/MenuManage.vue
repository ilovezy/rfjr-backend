  ...
  <div class="app-container">
    ...
    <div class='main-table-wrap'>
      <el-tabs v-model="currentTarget"
        ...
        <!--<el-tab-pane label="member(id: 3)"-->
        <!--value='member'-->
        <!--name="member"></el-tab-pane>-->
      </el-tabs>
      ...
      <el-row>
        ...
        <el-col :span='12'>
          <div style='margin-bottom: 20px;'>
            <el-button @click="resetNewMenu">增加菜单</el-button>

            <el-button @click="editMenu"
                       v-if='formData.id'
                       v-permission='["platform:account:menu:edit"]'
                       type='warning'>修改菜单
            </el-button>

            <el-button @click="addMenu"
                       v-else
                       v-permission='["platform:account:menu:create"]'
                       type='primary'>保存新菜单
            </el-button>

            <el-button @click="deleteMenu"
                       v-if='formData.id'
                       v-permission='["platform:account:menu:delete"]'
                       type='danger'>删除菜单
            </el-button>
          </div>
